(function($){
  $(function(){
	...
	if(window.location.hash == "#exists"){
		...
		toast("That name already exists in our database!",7000);
	}
	else if(window.location.hash == "#submit"){
		window.location.hash = "";
		toast("Name successfully added to database!",7000);
	}
	else if(window.location.hash == "#dne"){
		window.location.hash = "";
		toast("Invalid League In-game Name!",7000);
	}
